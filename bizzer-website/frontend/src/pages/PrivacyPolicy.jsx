    ...
    <div className="section">
      <div className="container-narrow">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            Bizzer Network S.L. ("Bizzer", "we", "us", or "our") is committed to protecting your
            privacy and ensuring compliance with the General Data Protection Regulation (GDPR) -
            Regulation (EU) 2016/679 - and the Spanish Organic Law 3/2018 on Personal Data Protection
          ...
          <ul>
            ...
            <li><strong>Address:</strong> Data Protection Officer, Bizzer Network S.L., [Address], [City], [Postal Code], Spain</li>
          </ul>
          ...
          <p>
            ...
            Economic Area (EEA). When we transfer data outside the EEA, we ensure appropriate
          ...
          <ul>
            ...
            <li><strong>Supplementary Measures:</strong> Additional technical and organizational measures as required</li>
          </ul>
          <p>
          ...
          <table className="w-full border-collapse border border-light-border dark:border-dark-border my-4">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-light-border dark:border-dark-border p-2">6 years (legal requirement)</td>
              </tr>
              <tr>
          ...
          <h3>9.1 Right of Access (Art. 15)</h3>
          <p>
          ...
          <h3>9.2 Right to Rectification (Art. 16)</h3>
          <p>
            You have the right to have inaccurate personal data corrected and incomplete data
            completed.
          </p>

          <h3>9.3 Right to Erasure / "Right to be Forgotten" (Art. 17)</h3>
          <p>
          ...
          <h3>9.4 Right to Restriction of Processing (Art. 18)</h3>
          <p>
          ...
          <h3>9.5 Right to Data Portability (Art. 20)</h3>
          <p>
          ...
          <h3>9.6 Right to Object (Art. 21)</h3>
          <p>
          ...
          <h3>9.7 Rights Related to Automated Decision-Making (Art. 22)</h3>
          <p>
          ...
          <p>
            We may ask you to verify your identity before processing your request. If your request
            is manifestly unfounded or excessive, we may charge a reasonable fee or refuse to act.
          </p>
          ...
          <p>
            ...
            lodge a complaint with a supervisory authority. In Spain, the competent authority is:
          </p>
          <div className="bg-light-bgSecondary dark:bg-dark-bgSecondary p-4 rounded-lg my-4">
            ...
            <p>Website: <a href="https://www.aepd.es" target="_blank" rel="noopener noreferrer" className="underline">www.aepd.es</a></p>
            <p>Phone: +34 901 100 099</p>
          </div>
          <p>
            You may also lodge a complaint with the supervisory authority in your country of
            residence or place of work if different from Spain.
          </p>
